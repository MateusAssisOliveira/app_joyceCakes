...
begin
  ...
  insert into public.inventory_movements (
    "tenantId", item_type, "supplyId", movement_type,
    quantity_delta, unit, unit_cost, note
  )
  values (
    p_tenant_id, 'supply', p_supply_id, p_movement_type,
    p_quantity_delta, v_unit, p_unit_cost, p_note
  );
...
create policy "inventory_movements tenant access" on public.inventory_movements
for all to authenticated
using (public.is_tenant_member("tenantId"))
with check (public.is_tenant_member("tenantId"));
